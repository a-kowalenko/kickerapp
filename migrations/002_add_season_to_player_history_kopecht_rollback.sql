-- Rollback: 002_add_season_to_player_history_kopecht.sql
-- This script reverts all changes made by adding season_id to player_history for kopecht schema
-- Run this BEFORE rolling back 001_create_seasons_kopecht.sql
...
DROP INDEX IF EXISTS kopecht.idx_player_history_season_id;

-- 3. Remove season_id column from player_history
ALTER TABLE kopecht.player_history DROP COLUMN IF EXISTS season_id;
