...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.match_comment_read_status TO authenticated;
GRANT USAGE ON SEQUENCE public.match_comment_read_status_id_seq TO authenticated;
