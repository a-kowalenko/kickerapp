...
INSERT INTO public.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM public.achievement_definitions WHERE key = 'mmr_1on1_1100' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO public.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM public.achievement_definitions WHERE key = 'mmr_1on1_1400' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO public.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM public.achievement_definitions WHERE key = 'mmr_2on2_1100' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO public.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM public.achievement_definitions WHERE key = 'mmr_2on2_1400' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
