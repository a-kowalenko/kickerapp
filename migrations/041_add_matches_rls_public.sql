-- Migration: Add RLS policies for public.matches table
...
DROP POLICY IF EXISTS "access_control_on_matches" ON public.matches;
DROP POLICY IF EXISTS "insert_control_on_matches" ON public.matches;
DROP POLICY IF EXISTS "update_control_on_matches" ON public.matches;
DROP POLICY IF EXISTS "delete_control_on_matches" ON public.matches;
