-- Migration 054: Create fatality notification trigger (public schema)
...
CREATE OR REPLACE FUNCTION public.trigger_create_fatality_notifications()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
BEGIN
    ...
    FOR v_player_record IN 
        ...
        INNER JOIN public.push_subscriptions ps ON ps.user_id = pl.user_id
...
CREATE TRIGGER trigger_fatality_notification
    ...
    FOR EACH ROW
    EXECUTE FUNCTION public.trigger_create_fatality_notifications();
