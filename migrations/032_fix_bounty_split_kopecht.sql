-- Migration: Fix bounty split in 2on2 matches AND Completionist achievement
-- Issue 1: Winners in 2on2 were getting 100% of bounty each instead of 50%
-- Issue 2: Completionist stuck at 50/150 because type was "threshold" instead of "counter"
-- Solution 1: Split bounty between winners in 2on2 matches
-- Solution 2: Change Completionist condition type to "counter"

-- FIX COMPLETIONIST: Change type from threshold to counter so progress increments properly
