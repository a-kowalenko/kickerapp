-- Migration: Create function to generate player_history entries when a season ends
...
CREATE OR REPLACE FUNCTION create_season_end_history(p_season_id BIGINT, p_kicker_id BIGINT)
RETURNS void AS $$
DECLARE
