...
-- ============================================
ALTER TABLE public.player_achievement_progress 
...
ON public.player_achievement_progress(season_id);
...
WHERE category_id IN (
    SELECT id FROM public.achievement_categories WHERE key = 'meta'
);
...
SET is_season_specific = false 
WHERE category_id IN (
    SELECT id FROM public.achievement_categories WHERE key = 'season'
);
...
BEGIN
    FOR kicker_rec IN SELECT id FROM public.kicker LOOP
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'matches_500_alltime_1on1' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'matches_500_alltime_2on2' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'wins_500_alltime_1on1' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'wins_500_alltime_2on2' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'goals_1000_alltime' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'goals_2500_alltime' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'playtime_100h_alltime' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
        ...
        INSERT INTO public.achievement_definitions (
            ...
            false,
            kicker_rec.id,
            (SELECT id FROM public.achievement_definitions WHERE key = 'playtime_250h_alltime' AND kicker_id = kicker_rec.id)
        ) ON CONFLICT (key, kicker_id) DO NOTHING;
