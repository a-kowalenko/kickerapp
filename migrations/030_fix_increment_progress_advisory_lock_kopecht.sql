...
COMMENT ON FUNCTION kopecht.increment_achievement_progress IS 'Atomically increments achievement progress using UPDATE-first pattern with exception handling for concurrent inserts.';
