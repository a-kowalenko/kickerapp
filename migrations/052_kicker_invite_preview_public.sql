-- Migration 052: Kicker Invite Preview Function (public schema)
...
-- ============================================
CREATE OR REPLACE FUNCTION public.get_kicker_invite_preview(
    invite_token uuid,
...
GRANT EXECUTE ON FUNCTION public.get_kicker_invite_preview(uuid, bigint) TO anon;
GRANT EXECUTE ON FUNCTION public.get_kicker_invite_preview(uuid, bigint) TO authenticated;
