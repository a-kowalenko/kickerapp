...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_10_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_25_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_100_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_250_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_10_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_25_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_100_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'first_blood_250_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'perfect_wins_5' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'early_bird_1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'early_bird_10' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'night_owl_1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'night_owl_10' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'after_meeting_party_10' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'after_meeting_party_25' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
