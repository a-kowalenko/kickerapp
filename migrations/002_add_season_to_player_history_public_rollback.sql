-- Rollback: 002_add_season_to_player_history_public.sql
-- This script reverts all changes made by adding season_id to player_history for public schema (PRODUCTION)
-- Run this BEFORE rolling back 001_create_seasons_public.sql
...
DROP INDEX IF EXISTS public.idx_player_history_season_id;

-- 3. Remove season_id column from player_history
ALTER TABLE public.player_history DROP COLUMN IF EXISTS season_id;
