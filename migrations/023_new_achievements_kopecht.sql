-- New Achievements Migration (kopecht schema)
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'win_streak_5_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'win_streak_10_1on1' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'win_streak_5_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'win_streak_10_2on2' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'goals_25_in_day' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
...
INSERT INTO kopecht.achievement_definitions (
    ...
    false,
    1,
    (SELECT id FROM kopecht.achievement_definitions WHERE key = 'goals_42_in_day' AND kicker_id = 1)
) ON CONFLICT (key, kicker_id) DO NOTHING;
