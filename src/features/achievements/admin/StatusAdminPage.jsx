...
import PlayerStatusTab from "./PlayerStatusTab";
...
function StatusAdminPage() {
    ...
    if (!isAdmin) {
        return (
            <AccessDenied>
                <h2>Access Denied</h2>
                <p>You must be a kicker admin to manage status settings.</p>
            </AccessDenied>
        );
    }
    ...
    return (
        <StyledAdmin>
            <TabContainer>
                ...
                >
                    <HiOutlineCog6Tooth /> <TabLabel>Display</TabLabel>
                </Tab>
            </TabContainer>

            {activeTab === "player" && <PlayerStatusTab />}
            {activeTab === "team" && <TeamStatusTab />}
            {activeTab === "display" && <StatusDisplaySettings />}
        </StyledAdmin>
    );
}
