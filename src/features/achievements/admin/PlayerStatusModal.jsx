...
import {
    useCreateAdminPlayerStatus,
    useUpdateAdminPlayerStatus,
...
function PlayerStatusModal({ item, viewMode, players, onClose }) {
    const { createPlayerStatus, isLoading: isCreating } =
        useCreateAdminPlayerStatus();
    const { updatePlayerStatus, isLoading: isUpdating } =
        useUpdateAdminPlayerStatus();
