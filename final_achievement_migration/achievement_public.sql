...
CREATE TABLE IF NOT EXISTS achievement_definitions (
    ...
    parent_id BIGINT REFERENCES achievement_definitions(id) ON DELETE SET NULL,
    sort_order INT NOT NULL DEFAULT 0,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
CREATE INDEX IF NOT EXISTS idx_achievement_definitions_trigger ON achievement_definitions(trigger_event);
CREATE INDEX IF NOT EXISTS idx_achievement_definitions_category ON achievement_definitions(category_id);
CREATE INDEX IF NOT EXISTS idx_achievement_definitions_parent ON achievement_definitions(parent_id);
CREATE INDEX IF NOT EXISTS idx_achievement_definitions_season ON achievement_definitions(season_id);
CREATE INDEX IF NOT EXISTS idx_player_achievement_progress_player ON player_achievement_progress(player_id);
CREATE INDEX IF NOT EXISTS idx_player_achievement_progress_achievement ON player_achievement_progress(achievement_id);
CREATE INDEX IF NOT EXISTS idx_player_achievement_progress_season ON player_achievement_progress(season_id);
...
CREATE POLICY "Users can view their own achievement progress"
    ON player_achievement_progress FOR SELECT
    USING (
        EXISTS (
...
CREATE POLICY "Service role can manage all progress"
    ON player_achievement_progress FOR ALL
    USING (auth.role() = 'service_role');
...
CREATE POLICY "Users can view achievements for players in their kickers"
    ...
    USING (
        EXISTS (
            SELECT 1 FROM player p
            JOIN player p2 ON p.kicker_id = p2.kicker_id
...
CREATE OR REPLACE FUNCTION update_achievement_definition_updated_at()
RETURNS TRIGGER AS $$
BEGIN
    NEW.updated_at = NOW();
    RETURN NEW;
...
CREATE TRIGGER update_achievement_definitions_updated_at
    ...
    FOR EACH ROW
    EXECUTE FUNCTION update_achievement_definition_updated_at();
...
INSERT INTO achievement_categories (key, name, description, icon, sort_order)
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'goals'),
    'GOAL_SCORED',
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_10')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_50')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_100')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_alltime_500')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_alltime_1000')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_1on1_alltime_2500')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_10')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_50')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_100')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_alltime_500')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_alltime_1000')
);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_2on2_alltime_2500')
);
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'speed'),
    'GOAL_SCORED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'matches'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_1on1_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_1on1_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_1on1_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_1on1_250')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_1on1_500')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_2on2_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_2on2_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_2on2_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_2on2_250')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_2on2_500')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'wins'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_25')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_250')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_1on1_500')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_25')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_250')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_2on2_500')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'streaks'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'comeback'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'skill'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_1on1_1100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_1on1_1200')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_1on1_1300')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_1on1_1400')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_2on2_1100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_2on2_1200')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_2on2_1300')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'mmr_2on2_1400')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'playtime'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'playtime_8h')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'playtime_16h')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'teamwork'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'secret'),
    'MATCH_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'season'),
    'SEASON_ENDED',
...
INSERT INTO achievement_definitions (
    ...
    (SELECT id FROM achievement_categories WHERE key = 'meta'),
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'achievement_hunter_25')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'win_streak_5_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'win_streak_10_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'win_streak_5_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'win_streak_10_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_25_in_day')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'goals_42_in_day')
) ON CONFLICT (key) DO NOTHING;
...
SET parent_id = (SELECT id FROM achievement_definitions WHERE key = 'achievement_hunter_50')
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'title_collector_1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'title_collector_5')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'title_collector_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'frame_collector_1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_10_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_25_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_100_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_250_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_10_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_25_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_100_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'first_blood_250_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'perfect_wins_5')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'early_bird_1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'early_bird_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'night_owl_1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'night_owl_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'after_meeting_party_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'after_meeting_party_25')
) ON CONFLICT (key) DO NOTHING;
...
-- 2. Die universelle Trigger-Funktion fÃ¼r Achievements im Schema 'public'
create or replace function trigger_process_achievement()
returns trigger 
language plpgsql
...
-- 3. Definition der Trigger auf den Tabellen im 'public' Schema

-- Webhook 1: on_achievement_unlocked_public
drop trigger if exists "on_achievement_unlocked_public" on player_achievements;
create trigger "on_achievement_unlocked_public"
after insert on player_achievements
for each row
execute function trigger_process_achievement('on_achievement_unlocked_public');

-- Webhook 2: achievement-match-ended_public
drop trigger if exists "achievement-match-ended_public" on matches;
create trigger "achievement-match-ended_public"
after update on matches
for each row
execute function trigger_process_achievement('achievement-match-ended_public');

-- Webhook 3: achievement-goal-scored_public
drop trigger if exists "achievement-goal-scored_public" on goals;
create trigger "achievement-goal-scored_public"
after insert on goals
for each row
execute function trigger_process_achievement('achievement-goal-scored_public');

-- Webhook 4: achievement-season-ended_public
drop trigger if exists "achievement-season-ended_public" on seasons;
create trigger "achievement-season-ended_public"
after update on seasons
for each row
execute function trigger_process_achievement('achievement-season-ended_public');
...
-- Create the trigger
DROP TRIGGER IF EXISTS on_achievement_unlocked ON player_achievements;
...
GRANT EXECUTE ON FUNCTION notify_achievement_unlocked() TO service_role;
...
ON player_achievement_progress(season_id);
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_500_alltime_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'matches_500_alltime_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_500_alltime_1on1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'wins_500_alltime_2on2')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'playtime_100h_alltime')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'playtime_250h_alltime')
) ON CONFLICT (key) DO NOTHING;
...
DROP FUNCTION IF EXISTS increment_achievement_progress(BIGINT, BIGINT, BIGINT, INTEGER, BIGINT);
...
GRANT EXECUTE ON FUNCTION increment_achievement_progress TO service_role;
...
CREATE OR REPLACE FUNCTION atomic_increment_progress(
    p_player_id BIGINT,
    p_achievement_id BIGINT,
    p_increment INTEGER DEFAULT 1,
...
-- Grant execute permission
GRANT EXECUTE ON FUNCTION atomic_increment_progress TO authenticated;
GRANT EXECUTE ON FUNCTION atomic_increment_progress TO service_role;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_season_10')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_season_25')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_season_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_alltime_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_alltime_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'own_goals_alltime_250')
) ON CONFLICT (key) DO NOTHING;
...
-- ============================================
CREATE TABLE IF NOT EXISTS player_selected_rewards (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    player_id BIGINT NOT NULL REFERENCES player(id) ON DELETE CASCADE,
    reward_type TEXT NOT NULL CHECK (reward_type IN ('title', 'frame')),
    reward_id BIGINT REFERENCES reward_definitions(id) ON DELETE SET NULL,
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
-- INDEXES
-- ============================================
CREATE INDEX IF NOT EXISTS idx_reward_definitions_type ON reward_definitions(type);
CREATE INDEX IF NOT EXISTS idx_reward_definitions_achievement ON reward_definitions(achievement_key);
CREATE INDEX IF NOT EXISTS idx_player_selected_rewards_player ON player_selected_rewards(player_id);

-- ============================================
-- RLS POLICIES
-- ============================================
ALTER TABLE reward_definitions ENABLE ROW LEVEL SECURITY;
ALTER TABLE player_selected_rewards ENABLE ROW LEVEL SECURITY;

-- Reward definitions: Everyone can read
CREATE POLICY "reward_definitions_select_policy" ON reward_definitions
    FOR SELECT USING (true);

-- Reward definitions: Only super admin can insert/update/delete
CREATE POLICY "reward_definitions_insert_policy" ON reward_definitions
    FOR INSERT WITH CHECK (auth.uid() = 'caeedd2f-5809-41ff-8a79-0c4c64836d2b'::uuid);

CREATE POLICY "reward_definitions_update_policy" ON reward_definitions
    FOR UPDATE USING (auth.uid() = 'caeedd2f-5809-41ff-8a79-0c4c64836d2b'::uuid);

CREATE POLICY "reward_definitions_delete_policy" ON reward_definitions
...
CREATE POLICY "player_selected_rewards_select_policy" ON player_selected_rewards
    FOR SELECT USING (true);

CREATE POLICY "player_selected_rewards_insert_policy" ON player_selected_rewards
    FOR INSERT WITH CHECK (
        player_id IN (SELECT id FROM player WHERE user_id = auth.uid())
    );

CREATE POLICY "player_selected_rewards_update_policy" ON player_selected_rewards
    FOR UPDATE USING (
        player_id IN (SELECT id FROM player WHERE user_id = auth.uid())
    );

CREATE POLICY "player_selected_rewards_delete_policy" ON player_selected_rewards
    FOR DELETE USING (
        player_id IN (SELECT id FROM player WHERE user_id = auth.uid())
    );
...
-- ============================================
CREATE OR REPLACE FUNCTION get_player_with_rewards(p_player_id BIGINT)
RETURNS TABLE (
    player_id BIGINT,
    player_name TEXT,
    avatar TEXT,
...
-- ============================================
CREATE OR REPLACE FUNCTION get_player_unlocked_rewards(p_player_id BIGINT)
RETURNS TABLE (
    reward_id BIGINT,
    reward_key TEXT,
    reward_name TEXT,
...
-- ============================================
CREATE OR REPLACE FUNCTION update_player_selected_reward(
    p_player_id BIGINT,
    p_reward_type TEXT,
...
-- Titles
INSERT INTO reward_definitions (key, name, description, type, display_position, display_value, achievement_key, icon, sort_order) VALUES
...
GRANT EXECUTE ON FUNCTION get_player_with_rewards(BIGINT) TO authenticated;
GRANT EXECUTE ON FUNCTION get_player_unlocked_rewards(BIGINT) TO authenticated;
GRANT EXECUTE ON FUNCTION update_player_selected_reward(BIGINT, TEXT, BIGINT) TO authenticated;
...
-- ============================================
CREATE TABLE IF NOT EXISTS player_monthly_status (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    player_id BIGINT NOT NULL REFERENCES player(id) ON DELETE CASCADE,
    gamemode TEXT NOT NULL CHECK (gamemode IN ('1on1', '2on2')),
...
CREATE TABLE IF NOT EXISTS bounty_history (
    ...
    claimer_id BIGINT NOT NULL REFERENCES player(id) ON DELETE CASCADE,
    -- Player whose streak was broken
    victim_id BIGINT NOT NULL REFERENCES player(id) ON DELETE CASCADE,
...
-- INDEXES
-- ============================================
CREATE INDEX IF NOT EXISTS idx_player_status_player ON player_status(player_id);
CREATE INDEX IF NOT EXISTS idx_player_status_updated ON player_status(updated_at);
CREATE INDEX IF NOT EXISTS idx_player_monthly_status_player ON player_monthly_status(player_id);
CREATE INDEX IF NOT EXISTS idx_player_monthly_status_month ON player_monthly_status(month);
CREATE INDEX IF NOT EXISTS idx_bounty_history_claimer ON bounty_history(claimer_id);
CREATE INDEX IF NOT EXISTS idx_bounty_history_victim ON bounty_history(victim_id);
CREATE INDEX IF NOT EXISTS idx_bounty_history_created ON bounty_history(created_at);
...
ALTER TABLE player_monthly_status ENABLE ROW LEVEL SECURITY;
ALTER TABLE bounty_history ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "player_status_select_policy" ON player_status
    FOR SELECT USING (true);

-- Player monthly status: Everyone can read
CREATE POLICY "player_monthly_status_select_policy" ON player_monthly_status
    FOR SELECT USING (true);

-- Bounty history: Everyone can read
CREATE POLICY "bounty_history_select_policy" ON bounty_history
    FOR SELECT USING (true);

-- ============================================
-- INSERT DEFAULT STATUS DEFINITIONS
-- ============================================
INSERT INTO status_definitions (key, name, description, type, condition, bounty_per_streak, bounty_cap, priority, asset_key) VALUES
-- Win streak statuses
...
-- ============================================
DROP FUNCTION IF EXISTS update_player_status_after_match(BIGINT, BIGINT, TEXT, BOOLEAN, INT, INT, INT);

CREATE OR REPLACE FUNCTION update_player_status_after_match(
    p_player_id BIGINT,
    p_match_id BIGINT,
    p_gamemode TEXT,
    p_is_winner BOOLEAN,
...
-- ============================================
CREATE OR REPLACE FUNCTION get_player_status(p_player_id BIGINT)
RETURNS TABLE (
    gamemode TEXT,
    current_streak INT,
    current_bounty INT,
...
-- ============================================
CREATE OR REPLACE FUNCTION get_players_with_bounties(
...
CREATE TABLE IF NOT EXISTS status_display_config (
    id SERIAL PRIMARY KEY,
    kicker_id INTEGER NOT NULL REFERENCES kicker(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_status_display_config_kicker ON status_display_config(kicker_id);

-- Insert default configuration for all existing kicker
INSERT INTO status_display_config (kicker_id, status_key, display_name, layer, priority, is_exclusive, is_enabled)
SELECT 
    k.id,
    s.status_key,
    s.display_name,
...
CREATE OR REPLACE FUNCTION get_status_display_config(p_kicker_id INTEGER)
RETURNS TABLE (
    id INTEGER,
...
CREATE OR REPLACE FUNCTION update_status_display_config(
    p_kicker_id INTEGER,
...
CREATE OR REPLACE FUNCTION batch_update_status_display_config(
    p_kicker_id INTEGER,
...
-- Grant permissions
GRANT SELECT, INSERT, UPDATE ON status_display_config TO authenticated;
GRANT USAGE ON SEQUENCE status_display_config_id_seq TO authenticated;
GRANT EXECUTE ON FUNCTION get_status_display_config(INTEGER) TO authenticated;
GRANT EXECUTE ON FUNCTION update_status_display_config(INTEGER, VARCHAR, VARCHAR, INTEGER, BOOLEAN, BOOLEAN) TO authenticated;
GRANT EXECUTE ON FUNCTION batch_update_status_display_config(INTEGER, JSONB) TO authenticated;

-- Enable RLS
ALTER TABLE status_display_config ENABLE ROW LEVEL SECURITY;

-- RLS Policies
CREATE POLICY "status_display_config_select_policy" ON status_display_config
    FOR SELECT USING (true);

CREATE POLICY "status_display_config_update_policy" ON status_display_config
    FOR UPDATE USING (
        EXISTS (
            SELECT 1 FROM kicker k
...
-- ============================================
CREATE OR REPLACE FUNCTION get_team_bounty(
    p_player_ids BIGINT[],
    p_gamemode TEXT
)
RETURNS INT AS $$
...
-- Grant execute permission
GRANT EXECUTE ON FUNCTION get_team_bounty(BIGINT[], TEXT) TO authenticated;

-- ============================================
-- 6. CREATE RPC TO UPDATE SEASON RANKINGS BOUNTY
-- Increments bounty_claimed for winners
-- ============================================
CREATE OR REPLACE FUNCTION add_bounty_to_season_rankings(
    p_player_id BIGINT,
    p_season_id BIGINT,
    p_bounty_amount INT,
    p_gamemode TEXT
...
-- Grant execute permission
GRANT EXECUTE ON FUNCTION add_bounty_to_season_rankings(BIGINT, BIGINT, INT, TEXT) TO authenticated;
...
COMMENT ON COLUMN matches.bounty_team1 IS 'Total bounty earned by team 1 in this match';
COMMENT ON COLUMN matches.bounty_team2 IS 'Total bounty earned by team 2 in this match';
COMMENT ON COLUMN season_rankings.bounty_claimed IS 'Total bounty claimed in 1on1 this season';
COMMENT ON COLUMN season_rankings.bounty_claimed_2on2 IS 'Total bounty claimed in 2on2 this season';
COMMENT ON COLUMN player_history.bounty_claimed IS 'Bounty claimed in 1on1 on this date';
COMMENT ON COLUMN player_history.bounty_claimed_2on2 IS 'Bounty claimed in 2on2 on this date';
...
-- Grant execute permission
GRANT EXECUTE ON FUNCTION update_player_status_after_match(BIGINT, BIGINT, TEXT, BOOLEAN, INT, INT, INT) TO authenticated;
GRANT EXECUTE ON FUNCTION update_player_status_after_match(BIGINT, BIGINT, TEXT, BOOLEAN, INT, INT, INT) TO service_role;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_hunter_1')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_hunter_5')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_collected_50')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_collected_100')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_earned_25')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_earned_75')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_earned_100_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_earned_250_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_collected_150_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'bounty_collected_300_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'secret_finder')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'achievement_points_5000')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    true,
    (SELECT id FROM achievement_definitions WHERE key = 'achievement_points_10000')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'achievements_100_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'achievements_250_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'achievement_points_15000_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'achievement_points_50000_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'secrets_10_global')
) ON CONFLICT (key) DO NOTHING;
...
INSERT INTO achievement_definitions (
    ...
    false,
    false,
    (SELECT id FROM achievement_definitions WHERE key = 'secrets_25_global')
) ON CONFLICT (key) DO NOTHING;
...
DROP TRIGGER IF EXISTS trg_goal_achievement_progress ON goals;
DROP FUNCTION IF EXISTS handle_goal_achievement_progress();

-- Create the trigger function
CREATE OR REPLACE FUNCTION handle_goal_achievement_progress()
RETURNS TRIGGER 
SECURITY DEFINER
...
CREATE TRIGGER trg_goal_achievement_progress
    AFTER INSERT ON goals
    FOR EACH ROW
    EXECUTE FUNCTION handle_goal_achievement_progress();

-- Grant execute permission
GRANT EXECUTE ON FUNCTION handle_goal_achievement_progress TO service_role;
...
UPDATE achievement_definitions SET max_progress = 5 WHERE key = 'win_streak_5_1on1';
UPDATE achievement_definitions SET max_progress = 5 WHERE key = 'win_streak_5_2on2';
UPDATE achievement_definitions SET max_progress = 10 WHERE key = 'win_streak_10_1on1';
UPDATE achievement_definitions SET max_progress = 10 WHERE key = 'win_streak_10_2on2';
UPDATE achievement_definitions SET max_progress = 15 WHERE key = 'win_streak_15_1on1';
UPDATE achievement_definitions SET max_progress = 15 WHERE key = 'win_streak_15_2on2';
...
ON bounty_history(claimer_id, victim_id, match_id);
...
CREATE OR REPLACE FUNCTION update_point_collector_progress(
    p_player_id BIGINT,
...
CREATE OR REPLACE FUNCTION sync_point_collector_on_achievement()
RETURNS TRIGGER AS $$
DECLARE
...
DROP TRIGGER IF EXISTS sync_point_collector_trigger ON player_achievements;
CREATE TRIGGER sync_point_collector_trigger
    AFTER INSERT ON player_achievements
    FOR EACH ROW
    EXECUTE FUNCTION sync_point_collector_on_achievement();

-- Grant execute permissions
GRANT EXECUTE ON FUNCTION sync_point_collector_on_achievement() TO service_role;
GRANT EXECUTE ON FUNCTION update_point_collector_progress(BIGINT, TEXT, INTEGER, BIGINT) TO service_role;
...
-- ============================================
DROP POLICY IF EXISTS "Authenticated users can view achievement categories" ON achievement_categories;
...
GRANT SELECT ON achievement_categories TO anon;
GRANT SELECT ON achievement_definitions TO authenticated;
GRANT SELECT ON achievement_definitions TO anon;
-- ============================================
